...
public interface IAdbClient
{
    ...
    Task<bool> IsAppInstalledAsync(string deviceSerial, string packageName, CancellationToken ct = default);
    Task<bool> StartGuestAgentServiceAsync(string deviceSerial, CancellationToken ct = default);
